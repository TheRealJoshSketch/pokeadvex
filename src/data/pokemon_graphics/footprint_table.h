const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_TOTARTLE] = gMonFootprint_Totartle,
    [SPECIES_GOROCHU] = gMonFootprint_Gorochu,
    [SPECIES_SLATEON] = gMonFootprint_Slateon,
    [SPECIES_CRAGEON] = gMonFootprint_Crageon,
    [SPECIES_BREEZEON] = gMonFootprint_Breezeon,
    [SPECIES_COINPUR] = gMonFootprint_Coinpur,
    [SPECIES_PERRSERKER] = gMonFootprint_Perrserker,
    [SPECIES_GENTLARVA] = gMonFootprint_Gentlarva,
    [SPECIES_PUPAL] = gMonFootprint_Pupal,
    [SPECIES_CARAPTHOR] = gMonFootprint_Carapthor,
    [SPECIES_KOTORA] = gMonFootprint_Kotora,
    [SPECIES_GAOTORA] = gMonFootprint_Gaotora,
    [SPECIES_GOROTORA] = gMonFootprint_Gorotora,
    [SPECIES_NIDOREIGN] = gMonFootprint_Nidoreign,
    [SPECIES_BITTYBAT] = gMonFootprint_Bittybat,
    [SPECIES_PARA] = gMonFootprint_Para,
    [SPECIES_VULPIII] = gMonFootprint_Vulpiii,
    [SPECIES_ANIHILAPE] = gMonFootprint_Anihilape,
    [SPECIES_BELLIGNAN] = gMonFootprint_Bellignan,
    [SPECIES_ORFRY] = gMonFootprint_Orfry,
    [SPECIES_WEIRDUCK] = gMonFootprint_Weirduck,
    [SPECIES_CHEEP] = gMonFootprint_Cheep,
    [SPECIES_JABETTA] = gMonFootprint_Jabetta,
    [SPECIES_LATHERLICK] = gMonFootprint_Latherlick,
    [SPECIES_PUDI] = gMonFootprint_Pudi,
    [SPECIES_LUXWAN] = gMonFootprint_Luxwan,
    [SPECIES_SIRFETCHD] = gMonFootprint_Sirfetchd,
    [SPECIES_MAGNETITE] = gMonFootprint_Magnetite,
    [SPECIES_MAGNEZONE] = gMonFootprint_Magnezone,
    [SPECIES_GAVILLAIN] = gMonFootprint_Gavillain,
    [SPECIES_KOLTA] = gMonFootprint_Kolta,
    [SPECIES_GUARDIA] = gMonFootprint_Guardia,
    [SPECIES_BALUMBA] = gMonFootprint_Balumba,
    [SPECIES_NESTRIO] = gMonFootprint_Nestrio,
    [SPECIES_STAINY] = gMonFootprint_Stainy,
    [SPECIES_MONJA] = gMonFootprint_Monja,
    [SPECIES_TANGROWTH] = gMonFootprint_Tangrowth,
    [SPECIES_TRICKELA] = gMonFootprint_Trickela,
    [SPECIES_RAMOOSE] = gMonFootprint_Ramoose,
    [SPECIES_DISTURBAN] = gMonFootprint_Disturban,
    [SPECIES_BLASTYKE] = gMonFootprint_Blastyke,
    [SPECIES_SHARPOON] = gMonFootprint_Sharpoon,
    [SPECIES_RHYPERIOR] = gMonFootprint_Rhyperior,
    [SPECIES_KLEAVOR] = gMonFootprint_Kleavor,
    [SPECIES_TRICULES] = gMonFootprint_Tricules,
    [SPECIES_TRAMPEL] = gMonFootprint_Trampel,
    [SPECIES_HAPPINY] = gMonFootprint_Happiny,
    [SPECIES_CYMBONK] = gMonFootprint_Cymbonk,
    [SPECIES_GORILLAIMO] = gMonFootprint_Gorillaimo,
    [SPECIES_POWRILLA] = gMonFootprint_Powrilla,
    [SPECIES_CACTOMUS] = gMonFootprint_Cactomus,
    [SPECIES_MIME_JR] = gMonFootprint_Mime_Jr,
    [SPECIES_MR_RIME] = gMonFootprint_Mr_Rime,
    [SPECIES_SUBZAW] = gMonFootprint_Subzaw,
    [SPECIES_BUU] = gMonFootprint_Buu,
    [SPECIES_ELECTAVIRE] = gMonFootprint_Electavire,
    [SPECIES_MAGMORTAR] = gMonFootprint_Magmortar,
    [SPECIES_MIMMEO] = gMonFootprint_Mimmeo,
    [SPECIES_PORYGON_Z] = gMonFootprint_Porygon_Z,
    [SPECIES_PORYGON3] = gMonFootprint_Porygon3,
    [SPECIES_DECILLA] = gMonFootprint_Decilla,
    [SPECIES_GAWARHEAD] = gMonFootprint_Gawarhead,
    [SPECIES_OMEGADGE] = gMonFootprint_Omegadge,
    [SPECIES_SQUEAMATA] = gMonFootprint_Squeamata,
    [SPECIES_MINISTARE] = gMonFootprint_Ministare,
    [SPECIES_IGUANARCH] = gMonFootprint_Iguanarch,
