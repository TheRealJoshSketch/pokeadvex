const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(TOTARTLE, gMonShinyPalette_Totartle),
    SPECIES_SHINY_PAL(GOROCHU, gMonShinyPalette_Gorochu),
    SPECIES_SHINY_PAL(SLATEON, gMonShinyPalette_Slateon),
    SPECIES_SHINY_PAL(CRAGEON, gMonShinyPalette_Crageon),
    SPECIES_SHINY_PAL(BREEZEON, gMonShinyPalette_Breezeon),
    SPECIES_SHINY_PAL(COINPUR, gMonShinyPalette_Coinpur),
    SPECIES_SHINY_PAL(PERRSERKER, gMonShinyPalette_Perrserker),
    SPECIES_SHINY_PAL(GENTLARVA, gMonShinyPalette_Gentlarva),
    SPECIES_SHINY_PAL(PUPAL, gMonShinyPalette_Pupal),
    SPECIES_SHINY_PAL(CARAPTHOR, gMonShinyPalette_Carapthor),
    SPECIES_SHINY_PAL(KOTORA, gMonShinyPalette_Kotora),
    SPECIES_SHINY_PAL(GAOTORA, gMonShinyPalette_Gaotora),
    SPECIES_SHINY_PAL(GOROTORA, gMonShinyPalette_Gorotora),
    SPECIES_SHINY_PAL(NIDOREIGN, gMonShinyPalette_Nidoreign),
    SPECIES_SHINY_PAL(BITTYBAT, gMonShinyPalette_Bittybat),
    SPECIES_SHINY_PAL(PARA, gMonShinyPalette_Para),
    SPECIES_SHINY_PAL(VULPIII, gMonShinyPalette_Vulpiii),
    SPECIES_SHINY_PAL(ANIHILAPE, gMonShinyPalette_Anihilape),
    SPECIES_SHINY_PAL(BELLIGNAN, gMonShinyPalette_Bellignan),
    SPECIES_SHINY_PAL(ORFRY, gMonShinyPalette_Orfry),
    SPECIES_SHINY_PAL(WEIRDUCK, gMonShinyPalette_Weirduck),
    SPECIES_SHINY_PAL(CHEEP, gMonShinyPalette_Cheep),
    SPECIES_SHINY_PAL(JABETTA, gMonShinyPalette_Jabetta),
    SPECIES_SHINY_PAL(LATHERLICK, gMonShinyPalette_Latherlick),
    SPECIES_SHINY_PAL(PUDI, gMonShinyPalette_Pudi),
    SPECIES_SHINY_PAL(LUXWAN, gMonShinyPalette_Luxwan),
    SPECIES_SHINY_PAL(SIRFETCHD, gMonShinyPalette_Sirfetchd),
    SPECIES_SHINY_PAL(MAGNETITE, gMonShinyPalette_Magnetite),
    SPECIES_SHINY_PAL(MAGNEZONE, gMonShinyPalette_Magnezone),
    SPECIES_SHINY_PAL(GAVILLAIN, gMonShinyPalette_Gavillain),
    SPECIES_SHINY_PAL(KOLTA, gMonShinyPalette_Kolta),
    SPECIES_SHINY_PAL(GUARDIA, gMonShinyPalette_Guardia),
    SPECIES_SHINY_PAL(BALUMBA, gMonShinyPalette_Balumba),
    SPECIES_SHINY_PAL(NESTRIO, gMonShinyPalette_Nestrio),
    SPECIES_SHINY_PAL(STAINY, gMonShinyPalette_Stainy),
    SPECIES_SHINY_PAL(MONJA, gMonShinyPalette_Monja),
    SPECIES_SHINY_PAL(TANGROWTH, gMonShinyPalette_Tangrowth),
    SPECIES_SHINY_PAL(TRICKELA, gMonShinyPalette_Trickela),
    SPECIES_SHINY_PAL(RAMOOSE, gMonShinyPalette_Ramoose),
    SPECIES_SHINY_PAL(DISTURBAN, gMonShinyPalette_Disturban),
    SPECIES_SHINY_PAL(BLASTYKE, gMonShinyPalette_Blastyke),
    SPECIES_SHINY_PAL(SHARPOON, gMonShinyPalette_Sharpoon),
    ...
    SPECIES_SHINY_PAL(TRAMPEL, gMonShinyPalette_Trampel),
    SPECIES_SHINY_PAL(HAPPINY, gMonShinyPalette_Happiny),
    SPECIES_SHINY_PAL(CYMBONK, gMonShinyPalette_Cymbonk),
    SPECIES_SHINY_PAL(GORILLAIMO, gMonShinyPalette_Gorillaimo),
    SPECIES_SHINY_PAL(POWRILLA, gMonShinyPalette_Powrilla),
    SPECIES_SHINY_PAL(CACTOMUS, gMonShinyPalette_Cactomus),
    SPECIES_SHINY_PAL(MIME_JR, gMonShinyPalette_Mime_Jr),
    SPECIES_SHINY_PAL(MR_RIME, gMonShinyPalette_Mr_Rime),
    SPECIES_SHINY_PAL(SUBZAW, gMonShinyPalette_Subzaw),
    SPECIES_SHINY_PAL(BUU, gMonShinyPalette_Buu),
    SPECIES_SHINY_PAL(ELECTAVIRE, gMonShinyPalette_Electavire),
    SPECIES_SHINY_PAL(MAGMORTAR, gMonShinyPalette_Magmortar),
    SPECIES_SHINY_PAL(MIMMEO, gMonShinyPalette_Mimmeo),
    SPECIES_SHINY_PAL(PORYGON_Z, gMonShinyPalette_Porygon_Z),
    SPECIES_SHINY_PAL(PORYGON3, gMonShinyPalette_Porygon3),
    SPECIES_SHINY_PAL(DECILLA, gMonShinyPalette_Decilla),
    SPECIES_SHINY_PAL(GAWARHEAD, gMonShinyPalette_Gawarhead),
    SPECIES_SHINY_PAL(OMEGADGE, gMonShinyPalette_Omegadge),
    SPECIES_SHINY_PAL(SQUEAMATA, gMonShinyPalette_Squeamata),
    SPECIES_SHINY_PAL(MINISTARE, gMonShinyPalette_Ministare),
    SPECIES_SHINY_PAL(IGUANARCH, gMonShinyPalette_Iguanarch),
