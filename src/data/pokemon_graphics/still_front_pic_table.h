...
// Gen III
    ...
    SPECIES_SPRITE(TOTARTLE,      gMonStillFrontPic_Totartle),
    SPECIES_SPRITE(GOROCHU,       gMonStillFrontPic_Gorochu),
    SPECIES_SPRITE(SLATEON,       gMonStillFrontPic_Slateon),
    SPECIES_SPRITE(CRAGEON,       gMonStillFrontPic_Crageon),
    SPECIES_SPRITE(BREEZEON,      gMonStillFrontPic_Breezeon),
    SPECIES_SPRITE(COINPUR,       gMonStillFrontPic_Coinpur),
    SPECIES_SPRITE(PERRSERKER,    gMonStillFrontPic_Perrserker),
    SPECIES_SPRITE(GENTLARVA,     gMonStillFrontPic_Gentlarva),
    SPECIES_SPRITE(PUPAL,         gMonStillFrontPic_Pupal),
    SPECIES_SPRITE(CARAPTHOR,     gMonStillFrontPic_Carapthor),
    SPECIES_SPRITE(KOTORA,        gMonStillFrontPic_Kotora),
    SPECIES_SPRITE(GAOTORA,       gMonStillFrontPic_Gaotora),
    SPECIES_SPRITE(GOROTORA,      gMonStillFrontPic_Gorotora),
    SPECIES_SPRITE(NIDOREIGN,     gMonStillFrontPic_Nidoreign),
    SPECIES_SPRITE(BITTYBAT,      gMonStillFrontPic_Bittybat),
    SPECIES_SPRITE(PARA,          gMonStillFrontPic_Para),
    SPECIES_SPRITE(VULPIII,       gMonStillFrontPic_Vulpiii),
    SPECIES_SPRITE(ANIHILAPE,     gMonStillFrontPic_Anihilape),
    SPECIES_SPRITE(BELLIGNAN,     gMonStillFrontPic_Bellignan),
    SPECIES_SPRITE(ORFRY,         gMonStillFrontPic_Orfry),
    SPECIES_SPRITE(WEIRDUCK,      gMonStillFrontPic_Weirduck),
    SPECIES_SPRITE(CHEEP,         gMonStillFrontPic_Cheep),
    SPECIES_SPRITE(JABETTA,       gMonStillFrontPic_Jabetta),
    SPECIES_SPRITE(LATHERLICK,    gMonStillFrontPic_Latherlick),
    SPECIES_SPRITE(PUDI,          gMonStillFrontPic_Pudi),
    SPECIES_SPRITE(LUXWAN,        gMonStillFrontPic_Luxwan),
    SPECIES_SPRITE(SIRFETCHD,     gMonStillFrontPic_Sirfetchd),
    SPECIES_SPRITE(MAGNETITE,     gMonStillFrontPic_Magnetite),
    SPECIES_SPRITE(MAGNEZONE,     gMonStillFrontPic_Magnezone),
    SPECIES_SPRITE(GAVILLAIN,     gMonStillFrontPic_Gavillain),
    SPECIES_SPRITE(KOLTA,         gMonStillFrontPic_Kolta),
    SPECIES_SPRITE(GUARDIA,       gMonStillFrontPic_Guardia),
    SPECIES_SPRITE(BALUMBA,       gMonStillFrontPic_Balumba),
    SPECIES_SPRITE(NESTRIO,       gMonStillFrontPic_Nestrio),
    SPECIES_SPRITE(STAINY,        gMonStillFrontPic_Stainy),
    SPECIES_SPRITE(MONJA,         gMonStillFrontPic_Monja),
    SPECIES_SPRITE(TANGROWTH,     gMonStillFrontPic_Tangrowth),
    SPECIES_SPRITE(TRICKELA,      gMonStillFrontPic_Trickela),
    SPECIES_SPRITE(RAMOOSE,       gMonStillFrontPic_Ramoose),
    SPECIES_SPRITE(DISTURBAN,     gMonStillFrontPic_Disturban),
    SPECIES_SPRITE(BLASTYKE,      gMonStillFrontPic_Blastyke),
    SPECIES_SPRITE(SHARPOON,      gMonStillFrontPic_Sharpoon),
    SPECIES_SPRITE(RHYPERIOR,     gMonStillFrontPic_Rhyperior),
    SPECIES_SPRITE(KLEAVOR,       gMonStillFrontPic_Kleavor),
    SPECIES_SPRITE(TRICULES,      gMonStillFrontPic_Tricules),
    SPECIES_SPRITE(TRAMPEL,       gMonStillFrontPic_Trampel),
    SPECIES_SPRITE(HAPPINY,       gMonStillFrontPic_Happiny),
    SPECIES_SPRITE(CYMBONK,       gMonStillFrontPic_Cymbonk),
    SPECIES_SPRITE(GORILLAIMO,    gMonStillFrontPic_Gorillaimo),
    SPECIES_SPRITE(POWRILLA,      gMonStillFrontPic_Powrilla),
    SPECIES_SPRITE(CACTOMUS,      gMonStillFrontPic_Cactomus),
    SPECIES_SPRITE(MIME_JR,       gMonStillFrontPic_Mime_Jr),
    SPECIES_SPRITE(MR_RIME,       gMonStillFrontPic_Mr_Rime),
    SPECIES_SPRITE(SUBZAW,        gMonStillFrontPic_Subzaw),
    SPECIES_SPRITE(BUU,           gMonStillFrontPic_Buu),
    SPECIES_SPRITE(ELECTAVIRE,    gMonStillFrontPic_Electavire),
    SPECIES_SPRITE(MAGMORTAR,     gMonStillFrontPic_Magmortar),
    SPECIES_SPRITE(MIMMEO,        gMonStillFrontPic_Mimmeo),
    SPECIES_SPRITE(PORYGON_Z,     gMonStillFrontPic_Porygon_Z),
    SPECIES_SPRITE(PORYGON3,      gMonStillFrontPic_Porygon3),
    SPECIES_SPRITE(DECILLA,       gMonStillFrontPic_Decilla),
    SPECIES_SPRITE(GAWARHEAD,     gMonStillFrontPic_Gawarhead),
    SPECIES_SPRITE(OMEGADGE,      gMonStillFrontPic_Omegadge),
    SPECIES_SPRITE(SQUEAMATA,     gMonStillFrontPic_Squeamata),
    SPECIES_SPRITE(MINISTARE,     gMonStillFrontPic_Ministare),
    SPECIES_SPRITE(IGUANARCH,     gMonStillFrontPic_Iguanarch),
