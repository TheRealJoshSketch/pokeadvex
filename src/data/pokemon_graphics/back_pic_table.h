const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(TOTARTLE, gMonBackPic_Totartle),
    SPECIES_SPRITE(GOROCHU, gMonBackPic_Gorochu),
    SPECIES_SPRITE(SLATEON, gMonBackPic_Slateon),
    SPECIES_SPRITE(CRAGEON, gMonBackPic_Crageon),
    SPECIES_SPRITE(BREEZEON, gMonBackPic_Breezeon),
    SPECIES_SPRITE(COINPUR, gMonBackPic_Coinpur),
    SPECIES_SPRITE(PERRSERKER, gMonBackPic_Perrserker),
    SPECIES_SPRITE(GENTLARVA, gMonBackPic_Gentlarva),
    SPECIES_SPRITE(PUPAL, gMonBackPic_Pupal),
    SPECIES_SPRITE(CARAPTHOR, gMonBackPic_Carapthor),
    SPECIES_SPRITE(KOTORA, gMonBackPic_Kotora),
    SPECIES_SPRITE(GAOTORA, gMonBackPic_Gaotora),
    SPECIES_SPRITE(GOROTORA, gMonBackPic_Gorotora),
    SPECIES_SPRITE(NIDOREIGN, gMonBackPic_Nidoreign),
    SPECIES_SPRITE(BITTYBAT, gMonBackPic_Bittybat),
    SPECIES_SPRITE(PARA, gMonBackPic_Para),
    SPECIES_SPRITE(VULPIII, gMonBackPic_Vulpiii),
    SPECIES_SPRITE(ANIHILAPE, gMonBackPic_Anihilape),
    SPECIES_SPRITE(BELLIGNAN, gMonBackPic_Bellignan),
    SPECIES_SPRITE(ORFRY, gMonBackPic_Orfry),
    SPECIES_SPRITE(WEIRDUCK, gMonBackPic_Weirduck),
    SPECIES_SPRITE(CHEEP, gMonBackPic_Cheep),
    SPECIES_SPRITE(JABETTA, gMonBackPic_Jabetta),
    SPECIES_SPRITE(LATHERLICK, gMonBackPic_Latherlick),
    SPECIES_SPRITE(PUDI, gMonBackPic_Pudi),
    SPECIES_SPRITE(LUXWAN, gMonBackPic_Luxwan),
    SPECIES_SPRITE(SIRFETCHD, gMonBackPic_Sirfetchd),
    SPECIES_SPRITE(MAGNETITE, gMonBackPic_Magnetite),
    SPECIES_SPRITE(MAGNEZONE, gMonBackPic_Magnezone),
    SPECIES_SPRITE(GAVILLAIN, gMonBackPic_Gavillain),
    SPECIES_SPRITE(KOLTA, gMonBackPic_Kolta),
    SPECIES_SPRITE(GUARDIA, gMonBackPic_Guardia),
    SPECIES_SPRITE(BALUMBA, gMonBackPic_Balumba),
    SPECIES_SPRITE(NESTRIO, gMonBackPic_Nestrio),
    SPECIES_SPRITE(STAINY, gMonBackPic_Stainy),
    SPECIES_SPRITE(MONJA, gMonBackPic_Monja),
    SPECIES_SPRITE(TANGROWTH, gMonBackPic_Tangrowth),
    SPECIES_SPRITE(TRICKELA, gMonBackPic_Trickela),
    SPECIES_SPRITE(RAMOOSE, gMonBackPic_Ramoose),
    SPECIES_SPRITE(DISTURBAN, gMonBackPic_Disturban),
    SPECIES_SPRITE(BLASTYKE, gMonBackPic_Blastyke),
    SPECIES_SPRITE(SHARPOON, gMonBackPic_Sharpoon),
    SPECIES_SPRITE(RHYPERIOR, gMonBackPic_Rhyperior),
    SPECIES_SPRITE(KLEAVOR, gMonBackPic_Kleavor),
    SPECIES_SPRITE(TRICULES, gMonBackPic_Tricules),
    SPECIES_SPRITE(TRAMPEL, gMonBackPic_Trampel),
    SPECIES_SPRITE(HAPPINY, gMonBackPic_Happiny),
    SPECIES_SPRITE(CYMBONK, gMonBackPic_Cymbonk),
    SPECIES_SPRITE(GORILLAIMO, gMonBackPic_Gorillaimo),
    SPECIES_SPRITE(POWRILLA, gMonBackPic_Powrilla),
    SPECIES_SPRITE(CACTOMUS, gMonBackPic_Cactomus),
    SPECIES_SPRITE(MIME_JR, gMonBackPic_Mime_Jr),
    SPECIES_SPRITE(MR_RIME, gMonBackPic_Mr_Rime),
    SPECIES_SPRITE(SUBZAW, gMonBackPic_Subzaw),
    SPECIES_SPRITE(BUU, gMonBackPic_Buu),
    SPECIES_SPRITE(ELECTAVIRE, gMonBackPic_Electavire),
    SPECIES_SPRITE(MAGMORTAR, gMonBackPic_Magmortar),
    SPECIES_SPRITE(MIMMEO, gMonBackPic_Mimmeo),
    SPECIES_SPRITE(PORYGON_Z, gMonBackPic_Porygon_Z),
    SPECIES_SPRITE(PORYGON3, gMonBackPic_Porygon3),
    SPECIES_SPRITE(DECILLA, gMonBackPic_Decilla),
    SPECIES_SPRITE(GAWARHEAD, gMonBackPic_Gawarhead),
    SPECIES_SPRITE(OMEGADGE, gMonBackPic_Omegadge),
    SPECIES_SPRITE(SQUEAMATA, gMonBackPic_Squeamata),
    SPECIES_SPRITE(MINISTARE, gMonBackPic_Ministare),
    SPECIES_SPRITE(IGUANARCH, gMonBackPic_Iguanarch),
