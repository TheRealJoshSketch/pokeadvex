const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(TOTARTLE, gMonFrontPic_Totartle),
    SPECIES_SPRITE(GOROCHU, gMonFrontPic_Gorochu),
    SPECIES_SPRITE(SLATEON, gMonFrontPic_Slateon),
    SPECIES_SPRITE(CRAGEON, gMonFrontPic_Crageon),
    SPECIES_SPRITE(BREEZEON, gMonFrontPic_Breezeon),
    SPECIES_SPRITE(COINPUR, gMonFrontPic_Coinpur),
    SPECIES_SPRITE(PERRSERKER, gMonFrontPic_Perrserker),
    SPECIES_SPRITE(GENTLARVA, gMonFrontPic_Gentlarva),
    SPECIES_SPRITE(PUPAL, gMonFrontPic_Pupal),
    SPECIES_SPRITE(CARAPTHOR, gMonFrontPic_Carapthor),
    SPECIES_SPRITE(KOTORA, gMonFrontPic_Kotora),
    SPECIES_SPRITE(GAOTORA, gMonFrontPic_Gaotora),
    SPECIES_SPRITE(GOROTORA, gMonFrontPic_Gorotora),
    SPECIES_SPRITE(NIDOREIGN, gMonFrontPic_Nidoreign),
    SPECIES_SPRITE(BITTYBAT, gMonFrontPic_Bittybat),
    SPECIES_SPRITE(PARA, gMonFrontPic_Para),
    SPECIES_SPRITE(VULPIII, gMonFrontPic_Vulpiii),
    SPECIES_SPRITE(ANIHILAPE, gMonFrontPic_Anihilape),
    SPECIES_SPRITE(BELLIGNAN, gMonFrontPic_Bellignan),
    SPECIES_SPRITE(ORFRY, gMonFrontPic_Orfry),
    SPECIES_SPRITE(WEIRDUCK, gMonFrontPic_Weirduck),
    SPECIES_SPRITE(CHEEP, gMonFrontPic_Cheep),
    SPECIES_SPRITE(JABETTA, gMonFrontPic_Jabetta),
    SPECIES_SPRITE(LATHERLICK, gMonFrontPic_Latherlick),
    SPECIES_SPRITE(PUDI, gMonFrontPic_Pudi),
    SPECIES_SPRITE(LUXWAN, gMonFrontPic_Luxwan),
    SPECIES_SPRITE(SIRFETCHD, gMonFrontPic_Sirfetchd),
    SPECIES_SPRITE(MAGNETITE, gMonFrontPic_Magnetite),
    SPECIES_SPRITE(MAGNEZONE, gMonFrontPic_Magnezone),
    SPECIES_SPRITE(GAVILLAIN, gMonFrontPic_Gavillain),
    SPECIES_SPRITE(KOLTA, gMonFrontPic_Kolta),
    SPECIES_SPRITE(GUARDIA, gMonFrontPic_Guardia),
    SPECIES_SPRITE(BALUMBA, gMonFrontPic_Balumba),
    SPECIES_SPRITE(NESTRIO, gMonFrontPic_Nestrio),
    SPECIES_SPRITE(STAINY, gMonFrontPic_Stainy),
    SPECIES_SPRITE(MONJA, gMonFrontPic_Monja),
    SPECIES_SPRITE(TANGROWTH, gMonFrontPic_Tangrowth),
    SPECIES_SPRITE(TRICKELA, gMonFrontPic_Trickela),
    SPECIES_SPRITE(RAMOOSE, gMonFrontPic_Ramoose),
    SPECIES_SPRITE(DISTURBAN, gMonFrontPic_Disturban),
    SPECIES_SPRITE(BLASTYKE, gMonFrontPic_Blastyke),
    SPECIES_SPRITE(SHARPOON, gMonFrontPic_Sharpoon),
    ...
    SPECIES_SPRITE(TRAMPEL, gMonFrontPic_Trampel),
    SPECIES_SPRITE(HAPPINY, gMonFrontPic_Happiny),
    SPECIES_SPRITE(CYMBONK, gMonFrontPic_Cymbonk),
    SPECIES_SPRITE(GORILLAIMO, gMonFrontPic_Gorillaimo),
    SPECIES_SPRITE(POWRILLA, gMonFrontPic_Powrilla),
    SPECIES_SPRITE(CACTOMUS, gMonFrontPic_Cactomus),
    SPECIES_SPRITE(MIME_JR, gMonFrontPic_Mime_Jr),
    SPECIES_SPRITE(MR_RIME, gMonFrontPic_Mr_Rime),
    SPECIES_SPRITE(SUBZAW, gMonFrontPic_Subzaw),
    SPECIES_SPRITE(BUU, gMonFrontPic_Buu),
    SPECIES_SPRITE(ELECTAVIRE, gMonFrontPic_Electavire),
    SPECIES_SPRITE(MAGMORTAR, gMonFrontPic_Magmortar),
    SPECIES_SPRITE(MIMMEO, gMonFrontPic_Mimmeo),
    SPECIES_SPRITE(PORYGON_Z, gMonFrontPic_Porygon_Z),
    SPECIES_SPRITE(PORYGON3, gMonFrontPic_Porygon3),
    SPECIES_SPRITE(DECILLA, gMonFrontPic_Decilla),
    SPECIES_SPRITE(GAWARHEAD, gMonFrontPic_Gawarhead),
    SPECIES_SPRITE(OMEGADGE, gMonFrontPic_Omegadge),
    SPECIES_SPRITE(SQUEAMATA, gMonFrontPic_Squeamata),
    SPECIES_SPRITE(MINISTARE, gMonFrontPic_Ministare),
    SPECIES_SPRITE(IGUANARCH, gMonFrontPic_Iguanarch),
