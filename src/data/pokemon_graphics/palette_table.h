const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(TOTARTLE, gMonPalette_Totartle),
    SPECIES_PAL(GOROCHU, gMonPalette_Gorochu),
    SPECIES_PAL(SLATEON, gMonPalette_Slateon),
    SPECIES_PAL(CRAGEON, gMonPalette_Crageon),
    SPECIES_PAL(BREEZEON, gMonPalette_Breezeon),
    SPECIES_PAL(COINPUR, gMonPalette_Coinpur),
    SPECIES_PAL(PERRSERKER, gMonPalette_Perrserker),
    SPECIES_PAL(GENTLARVA, gMonPalette_Gentlarva),
    SPECIES_PAL(PUPAL, gMonPalette_Pupal),
    SPECIES_PAL(CARAPTHOR, gMonPalette_Carapthor),
    SPECIES_PAL(KOTORA, gMonPalette_Kotora),
    SPECIES_PAL(GAOTORA, gMonPalette_Gaotora),
    SPECIES_PAL(GOROTORA, gMonPalette_Gorotora),
    SPECIES_PAL(NIDOREIGN, gMonPalette_Nidoreign),
    SPECIES_PAL(BITTYBAT, gMonPalette_Bittybat),
    SPECIES_PAL(PARA, gMonPalette_Para),
    SPECIES_PAL(VULPIII, gMonPalette_Vulpiii),
    SPECIES_PAL(ANIHILAPE, gMonPalette_Anihilape),
    SPECIES_PAL(BELLIGNAN, gMonPalette_Bellignan),
    SPECIES_PAL(ORFRY, gMonPalette_Orfry),
    SPECIES_PAL(WEIRDUCK, gMonPalette_Weirduck),
    SPECIES_PAL(CHEEP, gMonPalette_Cheep),
    SPECIES_PAL(JABETTA, gMonPalette_Jabetta),
    SPECIES_PAL(LATHERLICK, gMonPalette_Latherlick),
    SPECIES_PAL(PUDI, gMonPalette_Pudi),
    SPECIES_PAL(LUXWAN, gMonPalette_Luxwan),
    SPECIES_PAL(SIRFETCHD, gMonPalette_Sirfetchd),
    SPECIES_PAL(MAGNETITE, gMonPalette_Magnetite),
    SPECIES_PAL(MAGNEZONE, gMonPalette_Magnezone),
    SPECIES_PAL(GAVILLAIN, gMonPalette_Gavillain),
    SPECIES_PAL(KOLTA, gMonPalette_Kolta),
    SPECIES_PAL(GUARDIA, gMonPalette_Guardia),
    SPECIES_PAL(BALUMBA, gMonPalette_Balumba),
    SPECIES_PAL(NESTRIO, gMonPalette_Nestrio),
    SPECIES_PAL(STAINY, gMonPalette_Stainy),
    SPECIES_PAL(MONJA, gMonPalette_Monja),
    SPECIES_PAL(TANGROWTH, gMonPalette_Tangrowth),
    SPECIES_PAL(TRICKELA, gMonPalette_Trickela),
    SPECIES_PAL(RAMOOSE, gMonPalette_Ramoose),
    SPECIES_PAL(DISTURBAN, gMonPalette_Disturban),
    SPECIES_PAL(BLASTYKE, gMonPalette_Blastyke),
    SPECIES_PAL(SHARPOON, gMonPalette_Sharpoon),
    SPECIES_PAL(RHYPERIOR, gMonPalette_Rhyperior),
    SPECIES_PAL(KLEAVOR, gMonPalette_Kleavor),
    SPECIES_PAL(TRICULES, gMonPalette_Tricules),
    SPECIES_PAL(TRAMPEL, gMonPalette_Trampel),
    SPECIES_PAL(HAPPINY, gMonPalette_Happiny),
    SPECIES_PAL(CYMBONK, gMonPalette_Cymbonk),
    SPECIES_PAL(GORILLAIMO, gMonPalette_Gorillaimo),
    SPECIES_PAL(POWRILLA, gMonPalette_Powrilla),
    SPECIES_PAL(CACTOMUS, gMonPalette_Cactomus),
    SPECIES_PAL(MIME_JR, gMonPalette_Mime_Jr),
    SPECIES_PAL(MR_RIME, gMonPalette_Mr_Rime),
    SPECIES_PAL(SUBZAW, gMonPalette_Subzaw),
    SPECIES_PAL(BUU, gMonPalette_Buu),
    SPECIES_PAL(ELECTAVIRE, gMonPalette_Electavire),
    SPECIES_PAL(MAGMORTAR, gMonPalette_Magmortar),
    SPECIES_PAL(MIMMEO, gMonPalette_Mimmeo),
    SPECIES_PAL(PORYGON_Z, gMonPalette_Porygon_Z),
    SPECIES_PAL(PORYGON3, gMonPalette_Porygon3),
    SPECIES_PAL(DECILLA, gMonPalette_Decilla),
    SPECIES_PAL(GAWARHEAD, gMonPalette_Gawarhead),
    SPECIES_PAL(OMEGADGE, gMonPalette_Omegadge),
    SPECIES_PAL(SQUEAMATA, gMonPalette_Squeamata),
    SPECIES_PAL(MINISTARE, gMonPalette_Ministare),
    SPECIES_PAL(IGUANARCH, gMonPalette_Iguanarch),
