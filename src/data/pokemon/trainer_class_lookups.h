const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_YELLOW] = TRAINER_PIC_YELLOW,
    [FACILITY_CLASS_YELLOW_NO_HAT] = TRAINER_PIC_YELLOW_NO_HAT,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_YELLOW] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_YELLOW_NO_HAT] = TRAINER_CLASS_RIVAL,
};
