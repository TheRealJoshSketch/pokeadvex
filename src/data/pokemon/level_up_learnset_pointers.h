const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_TOTARTLE] = sTotartleLevelUpLearnset,
    [SPECIES_GOROCHU] = sGorochuLevelUpLearnset,
    [SPECIES_SLATEON] = sSlateonLevelUpLearnset,
    [SPECIES_CRAGEON] = sCrageonLevelUpLearnset,
    [SPECIES_BREEZEON] = sBreezeonLevelUpLearnset,
    [SPECIES_COINPUR] = sCoinpurLevelUpLearnset,
    [SPECIES_PERRSERKER] = sPerrserkerLevelUpLearnset,
    [SPECIES_GENTLARVA] = sGentlarvaLevelUpLearnset,
    [SPECIES_PUPAL] = sPupalLevelUpLearnset,
    [SPECIES_CARAPTHOR] = sCarapthorLevelUpLearnset,
    [SPECIES_KOTORA] = sKotoraLevelUpLearnset,
    [SPECIES_GAOTORA] = sGaotoraLevelUpLearnset,
    [SPECIES_GOROTORA] = sGorotoraLevelUpLearnset,
    [SPECIES_NIDOREIGN] = sNidoreignLevelUpLearnset,
    [SPECIES_BITTYBAT] = sBittybatLevelUpLearnset,
    [SPECIES_PARA] = sParaLevelUpLearnset,
    [SPECIES_VULPIII] = sVulpiiiLevelUpLearnset,
    [SPECIES_ANIHILAPE] = sAnihilapeLevelUpLearnset,
    [SPECIES_BELLIGNAN] = sBellignanLevelUpLearnset,
    [SPECIES_ORFRY] = sOrfryLevelUpLearnset,
    [SPECIES_WEIRDUCK] = sWeirduckLevelUpLearnset,
    [SPECIES_CHEEP] = sCheepLevelUpLearnset,
    [SPECIES_JABETTA] = sJabettaLevelUpLearnset,
    [SPECIES_LATHERLICK] = sLatherlickLevelUpLearnset,
    [SPECIES_PUDI] = sPudiLevelUpLearnset,
    [SPECIES_LUXWAN] = sLuxwanLevelUpLearnset,
    [SPECIES_SIRFETCHD] = sSirfetchdLevelUpLearnset,
    [SPECIES_MAGNETITE] = sMagnetiteLevelUpLearnset,
    [SPECIES_MAGNEZONE] = sMagnezoneLevelUpLearnset,
    [SPECIES_GAVILLAIN] = sGavillainLevelUpLearnset,
    [SPECIES_KOLTA] = sKoltaLevelUpLearnset,
    [SPECIES_GUARDIA] = sGuardiaLevelUpLearnset,
    [SPECIES_BALUMBA] = sBalumbaLevelUpLearnset,
    [SPECIES_NESTRIO] = sNestrioLevelUpLearnset,
    [SPECIES_STAINY] = sStainyLevelUpLearnset,
    [SPECIES_MONJA] = sMonjaLevelUpLearnset,
    [SPECIES_TANGROWTH] = sTangrowthLevelUpLearnset,
    [SPECIES_TRICKELA] = sTrickelaLevelUpLearnset,
    [SPECIES_RAMOOSE] = sRamooseLevelUpLearnset,
    [SPECIES_DISTURBAN] = sDisturbanLevelUpLearnset,
    [SPECIES_BLASTYKE] = sBlastykeLevelUpLearnset,
    [SPECIES_SHARPOON] = sSharpoonLevelUpLearnset,
    [SPECIES_RHYPERIOR] = sRhyperiorLevelUpLearnset,
    [SPECIES_KLEAVOR] = sKleavorLevelUpLearnset,
    [SPECIES_TRICULES] = sTriculesLevelUpLearnset,
    [SPECIES_TRAMPEL] = sTrampelLevelUpLearnset,
    [SPECIES_HAPPINY] = sHappinyLevelUpLearnset,
    [SPECIES_CYMBONK] = sCymbonkLevelUpLearnset,
    [SPECIES_GORILLAIMO] = sGorillaimoLevelUpLearnset,
    [SPECIES_POWRILLA] = sPowrillaLevelUpLearnset,
    [SPECIES_CACTOMUS] = sCactomusLevelUpLearnset,
    [SPECIES_MIME_JR] = sMimeJrLevelUpLearnset,
    [SPECIES_MR_RIME] = sMrRimeLevelUpLearnset,
    [SPECIES_SUBZAW] = sSubzawLevelUpLearnset,
    [SPECIES_BUU] = sBuuLevelUpLearnset,
    [SPECIES_ELECTAVIRE] = sElectavireLevelUpLearnset,
    [SPECIES_MAGMORTAR] = sMagmortarLevelUpLearnset,
    [SPECIES_MIMMEO] = sMimmeoLevelUpLearnset,
    [SPECIES_PORYGON_Z] = sPorygonZLevelUpLearnset,
    [SPECIES_PORYGON3] = sPorygon3LevelUpLearnset,
    [SPECIES_DECILLA] = sDecillaLevelUpLearnset,
    [SPECIES_GAWARHEAD] = sGawarheadLevelUpLearnset,
    [SPECIES_OMEGADGE] = sOmegadgeLevelUpLearnset,
    [SPECIES_SQUEAMATA] = sSqueamataLevelUpLearnset,
    [SPECIES_MINISTARE] = sMinistareLevelUpLearnset,
    [SPECIES_IGUANARCH] = sIguanarchLevelUpLearnset,
