const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_TOTARTLE] = _("TOTARTLE"),
    [SPECIES_GOROCHU] = _("GOROCHU"),
    [SPECIES_SLATEON] = _("SLATEON"),
    [SPECIES_CRAGEON] = _("CRAGEON"),
    [SPECIES_BREEZEON] = _("BREEZEON"),
    [SPECIES_COINPUR] = _("COINPUR"),
    [SPECIES_PERRSERKER] = _("PERRSERKER"),
    [SPECIES_GENTLARVA] = _("GENTLARVA"),
    [SPECIES_PUPAL] = _("PUPAL"),
    [SPECIES_CARAPTHOR] = _("CARAPTHOR"),
    [SPECIES_KOTORA] = _("KOTORA"),
    [SPECIES_GAOTORA] = _("GAOTORA"),
    [SPECIES_GOROTORA] = _("GOROTORA"),
    [SPECIES_NIDOREIGN] = _("NIDOREIGN"),
    [SPECIES_BITTYBAT] = _("BITTYBAT"),
    [SPECIES_PARA] = _("PARA"),
    [SPECIES_VULPIII] = _("VULPIII"),
    [SPECIES_ANIHILAPE] = _("ANIHILAPE"),
    [SPECIES_BELLIGNAN] = _("BELLIGNAN"),
    [SPECIES_ORFRY] = _("ORFRY"),
    [SPECIES_WEIRDUCK] = _("WEIRDUCK"),
    [SPECIES_CHEEP] = _("CHEEP"),
    [SPECIES_JABETTA] = _("JABETTA"),
    [SPECIES_LATHERLICK] = _("LATHERLICK"),
    [SPECIES_PUDI] = _("PUDI"),
    [SPECIES_LUXWAN] = _("LUXWAN"),
    [SPECIES_SIRFETCHD] = _("SIRFETCH'D"),
    [SPECIES_MAGNETITE] = _("MAGNETITE"),
    [SPECIES_MAGNEZONE] = _("MAGNEZONE"),
    [SPECIES_GAVILLAIN] = _("GAVILLAIN"),
    [SPECIES_KOLTA] = _("KOLTA"),
    [SPECIES_GUARDIA] = _("GUARDIA"),
    [SPECIES_BALUMBA] = _("BALUMBA"),
    [SPECIES_NESTRIO] = _("NESTRIO"),
    [SPECIES_STAINY] = _("STAINY"),
    [SPECIES_MONJA] = _("MONJA"),
    [SPECIES_TANGROWTH] = _("TANGROWTH"),
    [SPECIES_TRICKELA] = _("TRICKELA"),
    [SPECIES_RAMOOSE] = _("RAMOOSE"),
    [SPECIES_DISTURBAN] = _("DISTURBAN"),
    [SPECIES_BLASTYKE] = _("BLASTYKE"),
    [SPECIES_SHARPOON] = _("SHARPOON"),
    [SPECIES_RHYPERIOR] = _("RHYPERIOR"),
    [SPECIES_KLEAVOR] = _("KLEAVOR"),
    [SPECIES_TRICULES] = _("TRICULES"),
    [SPECIES_TRAMPEL] = _("TRAMPEL"),
    [SPECIES_HAPPINY] = _("HAPPINY"),
    [SPECIES_CYMBONK] = _("CYMBONK"),
    [SPECIES_GORILLAIMO] = _("GORILLAIMO"),
    [SPECIES_POWRILLA] = _("POWRILLA"),
    [SPECIES_CACTOMUS] = _("CACTOMUS"),
    [SPECIES_MIME_JR] = _("MIME JR."),
    [SPECIES_MR_RIME] = _("MR. RIME"),
    [SPECIES_SUBZAW] = _("SUBZAW"),
    [SPECIES_BUU] = _("BUU"),
    [SPECIES_ELECTAVIRE] = _("ELECTAVIRE"),
    [SPECIES_MAGMORTAR] = _("MAGMORTAR"),
    [SPECIES_MIMMEO] = _("MIMMEO"),
    [SPECIES_PORYGON_Z] = _("PORYGON-Z"),
    [SPECIES_PORYGON3] = _("PORYGON3"),
    [SPECIES_DECILLA] = _("DECILLA"),
    [SPECIES_GAWARHEAD] = _("GAWARHEAD"),
    [SPECIES_OMEGADGE] = _("OMEGADGE"),
    [SPECIES_SQUEAMATA] = _("SQUEAMATA"),
    [SPECIES_MINISTARE] = _("MINISTARE"),
    [SPECIES_IGUANARCH] = _("IGUANARCH"),
