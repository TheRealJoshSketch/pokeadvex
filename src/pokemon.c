...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(TOTARTLE),
    SPECIES_TO_HOENN(GOROCHU),
    SPECIES_TO_HOENN(SLATEON),
    SPECIES_TO_HOENN(CRAGEON),
    SPECIES_TO_HOENN(BREEZEON),
    SPECIES_TO_HOENN(COINPUR),
    SPECIES_TO_HOENN(PERRSERKER),
    SPECIES_TO_HOENN(GENTLARVA),
    SPECIES_TO_HOENN(PUPAL),
    SPECIES_TO_HOENN(CARAPTHOR),
    SPECIES_TO_HOENN(KOTORA),
    SPECIES_TO_HOENN(GAOTORA),
    SPECIES_TO_HOENN(GOROTORA),
    SPECIES_TO_HOENN(NIDOREIGN),
    SPECIES_TO_HOENN(BITTYBAT),
    SPECIES_TO_HOENN(PARA),
    SPECIES_TO_HOENN(VULPIII),
    SPECIES_TO_HOENN(ANIHILAPE),
    SPECIES_TO_HOENN(BELLIGNAN),
    SPECIES_TO_HOENN(ORFRY),
    SPECIES_TO_HOENN(WEIRDUCK),
    SPECIES_TO_HOENN(CHEEP),
    SPECIES_TO_HOENN(JABETTA),
    SPECIES_TO_HOENN(LATHERLICK),
    SPECIES_TO_HOENN(PUDI),
    SPECIES_TO_HOENN(LUXWAN),
    SPECIES_TO_HOENN(SIRFETCHD),
    SPECIES_TO_HOENN(MAGNETITE),
    SPECIES_TO_HOENN(MAGNEZONE),
    SPECIES_TO_HOENN(GAVILLAIN),
    SPECIES_TO_HOENN(KOLTA),
    SPECIES_TO_HOENN(GUARDIA),
    SPECIES_TO_HOENN(BALUMBA),
    SPECIES_TO_HOENN(NESTRIO),
    SPECIES_TO_HOENN(STAINY),
    SPECIES_TO_HOENN(MONJA),
    SPECIES_TO_HOENN(TANGROWTH),
    SPECIES_TO_HOENN(TRICKELA),
    SPECIES_TO_HOENN(RAMOOSE),
    SPECIES_TO_HOENN(DISTURBAN),
    SPECIES_TO_HOENN(BLASTYKE),
    SPECIES_TO_HOENN(SHARPOON),
    SPECIES_TO_HOENN(RHYPERIOR),
    SPECIES_TO_HOENN(KLEAVOR),
    SPECIES_TO_HOENN(TRICULES),
    SPECIES_TO_HOENN(TRAMPEL),
    SPECIES_TO_HOENN(HAPPINY),
    SPECIES_TO_HOENN(CYMBONK),
    SPECIES_TO_HOENN(GORILLAIMO),
    SPECIES_TO_HOENN(POWRILLA),
    SPECIES_TO_HOENN(CACTOMUS),
    SPECIES_TO_HOENN(MIME_JR),
    SPECIES_TO_HOENN(MR_RIME),
    SPECIES_TO_HOENN(SUBZAW),
    SPECIES_TO_HOENN(BUU),
    SPECIES_TO_HOENN(ELECTAVIRE),
    SPECIES_TO_HOENN(MAGMORTAR),
    SPECIES_TO_HOENN(MIMMEO),
    SPECIES_TO_HOENN(PORYGON_Z),
    SPECIES_TO_HOENN(PORYGON3),
    SPECIES_TO_HOENN(DECILLA),
    SPECIES_TO_HOENN(GAWARHEAD),
    SPECIES_TO_HOENN(OMEGADGE),
    SPECIES_TO_HOENN(SQUEAMATA),
    SPECIES_TO_HOENN(MINISTARE),
    SPECIES_TO_HOENN(IGUANARCH),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(TOTARTLE),
    SPECIES_TO_NATIONAL(GOROCHU),
    SPECIES_TO_NATIONAL(SLATEON),
    SPECIES_TO_NATIONAL(CRAGEON),
    SPECIES_TO_NATIONAL(BREEZEON),
    SPECIES_TO_NATIONAL(COINPUR),
    SPECIES_TO_NATIONAL(PERRSERKER),
    SPECIES_TO_NATIONAL(GENTLARVA),
    SPECIES_TO_NATIONAL(PUPAL),
    SPECIES_TO_NATIONAL(CARAPTHOR),
    SPECIES_TO_NATIONAL(KOTORA),
    SPECIES_TO_NATIONAL(GAOTORA),
    SPECIES_TO_NATIONAL(GOROTORA),
    SPECIES_TO_NATIONAL(NIDOREIGN),
    SPECIES_TO_NATIONAL(BITTYBAT),
    SPECIES_TO_NATIONAL(PARA),
    SPECIES_TO_NATIONAL(VULPIII),
    SPECIES_TO_NATIONAL(ANIHILAPE),
    SPECIES_TO_NATIONAL(BELLIGNAN),
    SPECIES_TO_NATIONAL(ORFRY),
    SPECIES_TO_NATIONAL(WEIRDUCK),
    SPECIES_TO_NATIONAL(CHEEP),
    SPECIES_TO_NATIONAL(JABETTA),
    SPECIES_TO_NATIONAL(LATHERLICK),
    SPECIES_TO_NATIONAL(PUDI),
    SPECIES_TO_NATIONAL(LUXWAN),
    SPECIES_TO_NATIONAL(SIRFETCHD),
    SPECIES_TO_NATIONAL(MAGNETITE),
    SPECIES_TO_NATIONAL(MAGNEZONE),
    SPECIES_TO_NATIONAL(GAVILLAIN),
    SPECIES_TO_NATIONAL(KOLTA),
    SPECIES_TO_NATIONAL(GUARDIA),
    SPECIES_TO_NATIONAL(BALUMBA),
    SPECIES_TO_NATIONAL(NESTRIO),
    SPECIES_TO_NATIONAL(STAINY),
    SPECIES_TO_NATIONAL(MONJA),
    SPECIES_TO_NATIONAL(TANGROWTH),
    SPECIES_TO_NATIONAL(TRICKELA),
    SPECIES_TO_NATIONAL(RAMOOSE),
    SPECIES_TO_NATIONAL(DISTURBAN),
    SPECIES_TO_NATIONAL(BLASTYKE),
    SPECIES_TO_NATIONAL(SHARPOON),
    SPECIES_TO_NATIONAL(RHYPERIOR),
    SPECIES_TO_NATIONAL(KLEAVOR),
    SPECIES_TO_NATIONAL(TRICULES),
    SPECIES_TO_NATIONAL(TRAMPEL),
    SPECIES_TO_NATIONAL(HAPPINY),
    SPECIES_TO_NATIONAL(CYMBONK),
    SPECIES_TO_NATIONAL(GORILLAIMO),
    SPECIES_TO_NATIONAL(POWRILLA),
    SPECIES_TO_NATIONAL(CACTOMUS),
    SPECIES_TO_NATIONAL(MIME_JR),
    SPECIES_TO_NATIONAL(MR_RIME),
    SPECIES_TO_NATIONAL(SUBZAW),
    SPECIES_TO_NATIONAL(BUU),
    SPECIES_TO_NATIONAL(ELECTAVIRE),
    SPECIES_TO_NATIONAL(MAGMORTAR),
    SPECIES_TO_NATIONAL(MIMMEO),
    SPECIES_TO_NATIONAL(PORYGON_Z),
    SPECIES_TO_NATIONAL(PORYGON3),
    SPECIES_TO_NATIONAL(DECILLA),
    SPECIES_TO_NATIONAL(GAWARHEAD),
    SPECIES_TO_NATIONAL(OMEGADGE),
    SPECIES_TO_NATIONAL(SQUEAMATA),
    SPECIES_TO_NATIONAL(MINISTARE),
    SPECIES_TO_NATIONAL(IGUANARCH),
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(TOTARTLE),
    HOENN_TO_NATIONAL(GOROCHU),
    HOENN_TO_NATIONAL(SLATEON),
    HOENN_TO_NATIONAL(CRAGEON),
    HOENN_TO_NATIONAL(BREEZEON),
    HOENN_TO_NATIONAL(COINPUR),
    HOENN_TO_NATIONAL(PERRSERKER),
    HOENN_TO_NATIONAL(GENTLARVA),
    HOENN_TO_NATIONAL(PUPAL),
    HOENN_TO_NATIONAL(CARAPTHOR),
    HOENN_TO_NATIONAL(KOTORA),
    HOENN_TO_NATIONAL(GAOTORA),
    HOENN_TO_NATIONAL(GOROTORA),
    HOENN_TO_NATIONAL(NIDOREIGN),
    HOENN_TO_NATIONAL(BITTYBAT),
    HOENN_TO_NATIONAL(PARA),
    HOENN_TO_NATIONAL(VULPIII),
    HOENN_TO_NATIONAL(ANIHILAPE),
    HOENN_TO_NATIONAL(BELLIGNAN),
    HOENN_TO_NATIONAL(ORFRY),
    HOENN_TO_NATIONAL(WEIRDUCK),
    HOENN_TO_NATIONAL(CHEEP),
    HOENN_TO_NATIONAL(JABETTA),
    HOENN_TO_NATIONAL(LATHERLICK),
    HOENN_TO_NATIONAL(PUDI),
    HOENN_TO_NATIONAL(LUXWAN),
    HOENN_TO_NATIONAL(SIRFETCHD),
    HOENN_TO_NATIONAL(MAGNETITE),
    HOENN_TO_NATIONAL(MAGNEZONE),
    HOENN_TO_NATIONAL(GAVILLAIN),
    HOENN_TO_NATIONAL(KOLTA),
    HOENN_TO_NATIONAL(GUARDIA),
    HOENN_TO_NATIONAL(BALUMBA),
    HOENN_TO_NATIONAL(NESTRIO),
    HOENN_TO_NATIONAL(STAINY),
    HOENN_TO_NATIONAL(MONJA),
    HOENN_TO_NATIONAL(TANGROWTH),
    HOENN_TO_NATIONAL(TRICKELA),
    HOENN_TO_NATIONAL(RAMOOSE),
    HOENN_TO_NATIONAL(DISTURBAN),
    HOENN_TO_NATIONAL(BLASTYKE),
    HOENN_TO_NATIONAL(SHARPOON),
    HOENN_TO_NATIONAL(RHYPERIOR),
    HOENN_TO_NATIONAL(KLEAVOR),
    HOENN_TO_NATIONAL(TRICULES),
    HOENN_TO_NATIONAL(TRAMPEL),
    HOENN_TO_NATIONAL(HAPPINY),
    HOENN_TO_NATIONAL(CYMBONK),
    HOENN_TO_NATIONAL(GORILLAIMO),
    HOENN_TO_NATIONAL(POWRILLA),
    HOENN_TO_NATIONAL(CACTOMUS),
    HOENN_TO_NATIONAL(MIME_JR),
    HOENN_TO_NATIONAL(MR_RIME),
    HOENN_TO_NATIONAL(SUBZAW),
    HOENN_TO_NATIONAL(BUU),
    HOENN_TO_NATIONAL(ELECTAVIRE),
    HOENN_TO_NATIONAL(MAGMORTAR),
    HOENN_TO_NATIONAL(MIMMEO),
    HOENN_TO_NATIONAL(PORYGON_Z),
    HOENN_TO_NATIONAL(PORYGON3),
    HOENN_TO_NATIONAL(DECILLA),
    HOENN_TO_NATIONAL(GAWARHEAD),
    HOENN_TO_NATIONAL(OMEGADGE),
    HOENN_TO_NATIONAL(SQUEAMATA),
    HOENN_TO_NATIONAL(MINISTARE),
    HOENN_TO_NATIONAL(IGUANARCH),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_TOTARTLE - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_GOROCHU - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_SLATEON - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_CRAGEON - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_BREEZEON - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_COINPUR - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_PERRSERKER - 1]  = ANIM_ZIGZAG_FAST,
    [SPECIES_GENTLARVA - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_PUPAL - 1]       = ANIM_ZIGZAG_FAST,
    [SPECIES_CARAPTHOR - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_KOTORA - 1]      = ANIM_ZIGZAG_FAST,
    [SPECIES_GAOTORA - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_GOROTORA - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_NIDOREIGN - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_BITTYBAT - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_PARA - 1]        = ANIM_ZIGZAG_FAST,
    [SPECIES_VULPIII - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_ANIHILAPE - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_BELLIGNAN - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_ORFRY - 1]       = ANIM_ZIGZAG_FAST,
    [SPECIES_WEIRDUCK - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_CHEEP - 1]       = ANIM_ZIGZAG_FAST,
    [SPECIES_JABETTA - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_LATHERLICK - 1]  = ANIM_ZIGZAG_FAST,
    [SPECIES_PUDI - 1]        = ANIM_ZIGZAG_FAST,
    [SPECIES_LUXWAN - 1]      = ANIM_ZIGZAG_FAST,
    [SPECIES_SIRFETCHD - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_MAGNETITE - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_MAGNEZONE - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_GAVILLAIN - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_KOLTA - 1]       = ANIM_ZIGZAG_FAST,
    [SPECIES_GUARDIA - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_BALUMBA - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_NESTRIO - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_STAINY - 1]      = ANIM_ZIGZAG_FAST,
    [SPECIES_MONJA - 1]       = ANIM_ZIGZAG_FAST,
    [SPECIES_TANGROWTH - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_TRICKELA - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_RAMOOSE - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_DISTURBAN - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_BLASTYKE - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_SHARPOON - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_RHYPERIOR - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_KLEAVOR - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_TRICULES - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_TRAMPEL - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_HAPPINY - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_CYMBONK - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_GORILLAIMO - 1]  = ANIM_ZIGZAG_FAST,
    [SPECIES_POWRILLA - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_CACTOMUS - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_MIME_JR - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_MR_RIME - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_SUBZAW - 1]      = ANIM_ZIGZAG_FAST,
    [SPECIES_BUU - 1]         = ANIM_ZIGZAG_FAST,
    [SPECIES_ELECTAVIRE - 1]  = ANIM_ZIGZAG_FAST,
    [SPECIES_MAGMORTAR - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_MIMMEO - 1]      = ANIM_ZIGZAG_FAST,
    [SPECIES_PORYGON_Z - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_PORYGON3 - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_DECILLA - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_GAWARHEAD - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_OMEGADGE - 1]    = ANIM_ZIGZAG_FAST,
    [SPECIES_SQUEAMATA - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_MINISTARE - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_IGUANARCH - 1]   = ANIM_ZIGZAG_FAST,
    [SPECIES_MELTAN - 1]      = ANIM_ZIGZAG_FAST,
    [SPECIES_MELMETAL - 1]    = ANIM_ZIGZAG_FAST,
};
...
static const struct SpriteTemplate sTrainerBackSpriteTemplates[] =
{
    ...
    [TRAINER_BACK_PIC_YELLOW] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Yellow,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_YELLOW_NO_HAT] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Yellow_No_Hat,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
};
