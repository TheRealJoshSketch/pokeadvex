...
static const u8 sRivalAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_YELLOW_UNDERWATER,        OBJ_EVENT_GFX_YELLOW_NO_HAT_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_YELLOW_FISHING,           OBJ_EVENT_GFX_YELLOW_NO_HAT_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_YELLOW_WATERING,          OBJ_EVENT_GFX_YELLOW_NO_HAT_WATERING}
};

static const u8 sPlayerAvatarGfxIds[][GENDER_COUNT] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_YELLOW_NORMAL,     OBJ_EVENT_GFX_YELLOW_NO_HAT_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_YELLOW_MACH_BIKE,  OBJ_EVENT_GFX_YELLOW_NO_HAT_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_YELLOW_ACRO_BIKE,  OBJ_EVENT_GFX_YELLOW_NO_HAT_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_YELLOW_SURFING,    OBJ_EVENT_GFX_YELLOW_NO_HAT_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_YELLOW_UNDERWATER, OBJ_EVENT_GFX_YELLOW_NO_HAT_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_YELLOW_FIELD_MOVE, OBJ_EVENT_GFX_YELLOW_NO_HAT_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_YELLOW_FISHING,    OBJ_EVENT_GFX_YELLOW_NO_HAT_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_YELLOW_WATERING,   OBJ_EVENT_GFX_YELLOW_NO_HAT_WATERING},
};
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_YELLOW_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_YELLOW_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_YELLOW_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_YELLOW_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_YELLOW_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_YELLOW_NO_HAT_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_YELLOW_NO_HAT_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_YELLOW_NO_HAT_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_YELLOW_NO_HAT_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_YELLOW_NO_HAT_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
u8 unref_GetRivalAvatarGenderByGraphicsId(u8 gfxId)
{
    ...
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_UNDERWATER:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_FISHING:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
...
u8 GetPlayerAvatarGenderByGraphicsId(u8 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_NORMAL:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_MACH_BIKE:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_ACRO_BIKE:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_SURFING:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_FIELD_MOVE:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_UNDERWATER:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_FISHING:
    case OBJ_EVENT_GFX_YELLOW_NO_HAT_WATERING:
        return FEMALE;
