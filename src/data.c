...
const struct SpriteFrameImage gTrainerBackPicTable_Yellow[] =
{
    {gTrainerBackPic_Yellow + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Yellow + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Yellow + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Yellow + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Yellow + TRAINER_PIC_SIZE * 4, TRAINER_PIC_SIZE},
};

const struct SpriteFrameImage gTrainerBackPicTable_Yellow_No_Hat[] =
{
    {gTrainerBackPic_Yellow_No_Hat + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Yellow_No_Hat + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Yellow_No_Hat + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Yellow_No_Hat + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Yellow_No_Hat + TRAINER_PIC_SIZE * 4, TRAINER_PIC_SIZE},
};
