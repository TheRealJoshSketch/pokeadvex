...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_TOTARTLE] = gMonIcon_Totartle,
    [SPECIES_GOROCHU] = gMonIcon_Gorochu,
    [SPECIES_SLATEON] = gMonIcon_Slateon,
    [SPECIES_CRAGEON] = gMonIcon_Crageon,
    [SPECIES_BREEZEON] = gMonIcon_Breezeon,
    [SPECIES_COINPUR] = gMonIcon_Coinpur,
    [SPECIES_PERRSERKER] = gMonIcon_Perrserker,
    [SPECIES_GENTLARVA] = gMonIcon_Gentlarva,
    [SPECIES_PUPAL] = gMonIcon_Pupal,
    [SPECIES_CARAPTHOR] = gMonIcon_Carapthor,
    [SPECIES_KOTORA] = gMonIcon_Kotora,
    [SPECIES_GAOTORA] = gMonIcon_Gaotora,
    [SPECIES_GOROTORA] = gMonIcon_Gorotora,
    [SPECIES_NIDOREIGN] = gMonIcon_Nidoreign,
    [SPECIES_BITTYBAT] = gMonIcon_Bittybat,
    [SPECIES_PARA] = gMonIcon_Para,
    [SPECIES_VULPIII] = gMonIcon_Vulpiii,
    [SPECIES_ANIHILAPE] = gMonIcon_Anihilape,
    [SPECIES_BELLIGNAN] = gMonIcon_Bellignan,
    [SPECIES_ORFRY] = gMonIcon_Orfry,
    [SPECIES_WEIRDUCK] = gMonIcon_Weirduck,
    [SPECIES_CHEEP] = gMonIcon_Cheep,
    [SPECIES_JABETTA] = gMonIcon_Jabetta,
    [SPECIES_LATHERLICK] = gMonIcon_Latherlick,
    [SPECIES_PUDI] = gMonIcon_Pudi,
    [SPECIES_LUXWAN] = gMonIcon_Luxwan,
    [SPECIES_SIRFETCHD] = gMonIcon_Sirfetchd,
    [SPECIES_MAGNETITE] = gMonIcon_Magnetite,
    [SPECIES_MAGNEZONE] = gMonIcon_Magnezone,
    [SPECIES_GAVILLAIN] = gMonIcon_Gavillain,
    [SPECIES_KOLTA] = gMonIcon_Kolta,
    [SPECIES_GUARDIA] = gMonIcon_Guardia,
    [SPECIES_BALUMBA] = gMonIcon_Balumba,
    [SPECIES_NESTRIO] = gMonIcon_Nestrio,
    [SPECIES_STAINY] = gMonIcon_Stainy,
    [SPECIES_MONJA] = gMonIcon_Monja,
    [SPECIES_TANGROWTH] = gMonIcon_Tangrowth,
    [SPECIES_TRICKELA] = gMonIcon_Trickela,
    [SPECIES_RAMOOSE] = gMonIcon_Ramoose,
    [SPECIES_DISTURBAN] = gMonIcon_Disturban,
    [SPECIES_BLASTYKE] = gMonIcon_Blastyke,
    [SPECIES_SHARPOON] = gMonIcon_Sharpoon,
    [SPECIES_RHYPERIOR] = gMonIcon_Rhyperior,
    [SPECIES_KLEAVOR] = gMonIcon_Kleavor,
    [SPECIES_TRICULES] = gMonIcon_Tricules,
    [SPECIES_TRAMPEL] = gMonIcon_Trampel,
    [SPECIES_HAPPINY] = gMonIcon_Happiny,
    [SPECIES_CYMBONK] = gMonIcon_Cymbonk,
    [SPECIES_GORILLAIMO] = gMonIcon_Gorillaimo,
    [SPECIES_POWRILLA] = gMonIcon_Powrilla,
    [SPECIES_CACTOMUS] = gMonIcon_Cactomus,
    [SPECIES_MIME_JR] = gMonIcon_Mime_Jr,
    [SPECIES_MR_RIME] = gMonIcon_Mr_Rime,
    [SPECIES_SUBZAW] = gMonIcon_Subzaw,
    [SPECIES_BUU] = gMonIcon_Buu,
    [SPECIES_ELECTAVIRE] = gMonIcon_Electavire,
    [SPECIES_MAGMORTAR] = gMonIcon_Magmortar,
    [SPECIES_MIMMEO] = gMonIcon_Mimmeo,
    [SPECIES_PORYGON_Z] = gMonIcon_Porygon_Z,
    [SPECIES_PORYGON3] = gMonIcon_Porygon3,
    [SPECIES_DECILLA] = gMonIcon_Decilla,
    [SPECIES_GAWARHEAD] = gMonIcon_Gawarhead,
    [SPECIES_OMEGADGE] = gMonIcon_Omegadge,
    [SPECIES_SQUEAMATA] = gMonIcon_Squeamata,
    [SPECIES_MINISTARE] = gMonIcon_Ministare,
    [SPECIES_IGUANARCH] = gMonIcon_Iguanarch,
